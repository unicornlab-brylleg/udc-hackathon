  ...
  render() {
    return (
      <li
        ...
        key={utils.getIdentifierText(this.remoteParticipant.identifier)}
      >
        <div className="ms-Grid-row">
          <div className="ms-Grid-col ms-lg11 ms-sm10">
            <Persona
              className={
                this.state.isSpeaking ? `speaking-border-for-initials` : ``
              }
        ...
        <div className="text-right">
          <a
            ...
            className="participant-remove float-right ml-3"
          >
            Remove participant
          </a>
        </div>
